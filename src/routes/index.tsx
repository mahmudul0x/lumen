...
import {
  ShieldCheck, Building2, HandshakeIcon, Sparkles, ArrowRight,
  Clock, MapPin, Award, Users, Wrench, HardHat,
  BedDouble, ChefHat, ArrowUpDown, Zap, Radio, Bell,
  Camera, Car, Droplets, TrendingUp, LineChart, Landmark, Wallet,
  PlayCircle, Phone, MessageCircle, CalendarCheck, Trophy, Home as HomeIcon,
  ArrowUpRight, Ruler, BadgeCheck,
} from "lucide-react";
...
const ongoing: (Project & { progress: number; completion: string })[] = [
  { slug: "lumen-galaxy", name: "Lumen Galaxy", location: "আর. কে. রোড, রংপুর", status: "চলমান", type: "লাক্সারি অ্যাপার্টমেন্ট", image: projectGalaxy, progress: 62, completion: "ডিসেম্বর ২০২৬" },
  { slug: "lumen-jolchaya", name: "Lumen Jolchaya", location: "শাপলা চত্বর, রংপুর", status: "চলমান", type: "প্রিমিয়াম ফ্ল্যাট", image: projectJolchaya, progress: 45, completion: "জুন ২০২৭" },
  { slug: "lumen-skyline-heights", name: "Skyline Heights", location: "কলেজ রোড, রংপুর", status: "চলমান", type: "লাইফস্টাইল টাওয়ার", image: projectSkyline, progress: 28, completion: "মার্চ ২০২৮" },
];

const completed: Project[] = [
  { slug: "lumen-horizon", name: "Lumen Horizon", location: "মেডিকেল রোড, রংপুর", status: "সম্পন্ন", type: "গার্ডেন রেসিডেন্স", image: projectHorizon },
  { slug: "lumen-emerald-court", name: "Lumen Emerald Court", location: "ধাপ, রংপুর", status: "সম্পন্ন", type: "বুটিক রেসিডেন্স", image: projectEmerald },
];

const whyChoose = [
  { icon: ShieldCheck, title: "বিশ্বস্ত প্রতিষ্ঠান", description: "১০+ বছরের সুনামের সাথে হাজারো পরিবারের আস্থা।" },
  { icon: Sparkles, title: "আধুনিক নকশা", description: "আন্তর্জাতিক মানের স্থাপত্য ও প্রিমিয়াম ইন্টেরিয়র।" },
  { icon: Clock, title: "সময়মতো হস্তান্তর", description: "চুক্তি অনুযায়ী নির্ধারিত সময়ে চাবি হস্তান্তর।" },
  { icon: HardHat, title: "উন্নত নির্মাণ সামগ্রী", description: "আন্তর্জাতিক ব্র্যান্ডের যাচাইকৃত কনস্ট্রাকশন ম্যাটেরিয়াল।" },
  { icon: Wallet, title: "দীর্ঘমেয়াদী কিস্তি", description: "নমনীয় EMI পরিকল্পনা — সহজ শর্তে বুকিং।" },
  { icon: HandshakeIcon, title: "গ্রাহক সন্তুষ্টি", description: "হ্যান্ডওভারের পরেও নিয়মিত সাপোর্ট ও সেবা।" },
];
...
const investment = [
  ...
  { icon: TrendingUp, title: "ভবিষ্যৎ মূল্যবৃদ্ধি", desc: "প্রতি বছর গড়ে ১২-১৫% সম্পদ মূল্যায়ন।" },
  { icon: ShieldCheck, title: "নিরাপদ বিনিয়োগ", desc: "সম্পূর্ণ আইনি ডকুমেন্টেশন ও স্বচ্ছ চুক্তি।" },
  { icon: LineChart, title: "নমনীয় EMI", desc: "১২ মাস থেকে ৭২ মাস পর্যন্ত কিস্তি সুবিধা।" },
];

const blogs = [
  { title: "রিয়েল এস্টেটে বিনিয়োগ — নতুনদের জন্য সম্পূর্ণ গাইড", tag: "বিনিয়োগ", date: "১৫ জুন ২০২৬", image: corporateHero },
  { title: "রংপুরে ফ্ল্যাট কেনার আগে যা যাচাই করবেন", tag: "গাইড", date: "০৮ জুন ২০২৬", image: interior },
  { title: "জমি শেয়ার প্রকল্প কীভাবে কাজ করে?", tag: "প্রকল্প", date: "০১ জুন ২০২৬", image: handover },
];
...
function HomePage() {
  return (
    <SiteShell>
      ...
      <section className="container-luxury relative z-10 -mt-16">
        <motion.div
          initial={{ opacity: 0, y: 40 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          transition={{ duration: 0.7 }}
          className="grid gap-3 rounded-[28px] border border-border bg-surface p-4 shadow-float md:grid-cols-4 md:p-6"
        >
          {trustItems.map((t) => {
            const Icon = t.icon;
            return (
              <div
                key={t.label}
                className="group flex items-center gap-4 rounded-2xl p-4 transition hover:bg-primary-soft"
              >
                <div className="grid h-12 w-12 shrink-0 place-items-center rounded-xl bg-gradient-to-br from-primary to-primary/70 text-white shadow-soft transition group-hover:from-gold group-hover:to-gold group-hover:text-primary">
                  <Icon className="h-5 w-5" />
                </div>
                <span className="min-w-0 text-sm font-semibold text-foreground">{t.label}</span>
              </div>
            );
          })}
        </motion.div>
      ...
      <section className="container-luxury py-24">
        <div className="grid grid-cols-[minmax(0,1fr)_auto] items-end gap-6 sm:flex sm:flex-wrap sm:justify-between">
          ...
          <Button asChild variant="outline" className="shrink-0">
            <Link to="/projects/ongoing">সব প্রকল্প <ArrowRight className="h-4 w-4" /></Link>
          </Button>
        </div>
              ...
              <Link to="/projects/$slug" params={{ slug: p.slug }} className="block">
                <div className="relative aspect-[4/3] overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 right-4 text-white">
                    <p className="text-[11px] font-semibold uppercase tracking-widest text-gold">{p.type}</p>
                ...
                <div className="grid grid-cols-2 gap-4 border-t border-border p-6">
                  <div>
                    <p className="text-[11px] font-semibold uppercase tracking-widest text-muted-foreground">সাইজ</p>
                    <p className="mt-1 flex items-center gap-1.5 text-sm font-semibold text-foreground">
                      <Ruler className="h-3.5 w-3.5 text-gold" /> {p.size}
                    </p>
                  </div>
                  <div className="text-right">
                    <p className="text-[11px] font-semibold uppercase tracking-widest text-muted-foreground">শুরু</p>
      ...
      <section className="container-luxury py-24">
        <div className="grid grid-cols-[minmax(0,1fr)_auto] items-end gap-6 sm:flex sm:flex-wrap sm:justify-between">
          ...
          <Button asChild variant="outline" className="shrink-0">
            <Link to="/projects/ongoing">সব দেখুন <ArrowRight className="h-4 w-4" /></Link>
          </Button>
        </div>
          ...
          {ongoing.map((p) => (
            ...
            >
              <div className="relative aspect-[16/11] overflow-hidden">
                <img src={p.image} alt={p.name} className="h-full w-full object-cover transition duration-[1200ms] group-hover:scale-110" />
              ...
              <div className="p-6">
                ...
                <div className="mt-5">
                  ...
                  <div className="mt-2 h-1.5 overflow-hidden rounded-full bg-border">
                    <div className="h-full rounded-full bg-gradient-to-r from-primary to-gold" style={{ width: `${p.progress}%` }} />
                  </div>
                </div>
                <p className="mt-4 flex items-center gap-1.5 text-xs text-muted-foreground">
                  <Clock className="h-3.5 w-3.5 text-emerald" /> সম্পন্ন হবে: <span className="font-semibold text-foreground">{p.completion}</span>
                </p>
              </div>
            </Link>
          ))}
        ...
        <div className="container-luxury">
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-2 lg:auto-rows-[300px] lg:grid-cols-4">
            {[
              ...
              { name: "হ্যান্ডওভার মুহূর্ত", location: "রংপুর", image: handover, span: "lg:col-span-1" },
              { name: "ইন্টেরিয়র ফিনিশিং", location: "সম্পন্ন", image: interior, span: "lg:col-span-1" },
            ].map((p, i) => (
              <motion.div
                key={i}
              ...
              >
                <img src={p.image} alt={p.name} className="h-full w-full object-cover transition duration-[1500ms] group-hover:scale-110" />
      ...
      <section className="container-luxury py-24">
        <SectionHeader eyebrow="ফ্ল্যাট সুবিধাসমূহ" title="প্রতিটি ইউনিটে প্রিমিয়াম অ্যামেনিটিস" align="center" />
      ...
      <section className="relative overflow-hidden bg-primary text-white">
        <img src={construction} alt="" className="absolute inset-0 h-full w-full object-cover opacity-25" />
        ...
        <div className="container-luxury relative z-10 grid gap-14 py-24 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <p className="mt-5 max-w-xl text-white/85">
              আধুনিক প্রকৌশল, যাচাইকৃত সামগ্রী ও সর্বোচ্চ নিরাপত্তা মান — Lumen Builders-এর প্রতিটি প্রকল্পে অটল প্রতিশ্রুতি।
            </p>
            <div className="mt-10 grid gap-5 sm:grid-cols-2">
              {[
                { icon: Wrench, title: "কোয়ালিটি ম্যাটেরিয়াল", desc: "আন্তর্জাতিক ব্র্যান্ডের সিমেন্ট, রড ও ফিনিশিং।" },
                { icon: HardHat, title: "প্রকৌশল দক্ষতা", desc: "অভিজ্ঞ সিভিল ইঞ্জিনিয়ার ও স্থপতির তত্ত্বাবধান।" },
                { icon: ShieldCheck, title: "সেফটি স্ট্যান্ডার্ড", desc: "ভূমিকম্প-প্রতিরোধী ডিজাইন ও ফায়ার সেফটি।" },
                { icon: Sparkles, title: "আধুনিক প্রযুক্তি", desc: "BIM মডেলিং ও IoT-ভিত্তিক প্রজেক্ট ট্র্যাকিং।" },
              ].map((f) => {
                const Icon = f.icon;
                return (
                  <div key={f.title} className="flex gap-3 rounded-2xl border border-white/15 bg-white/5 p-4 backdrop-blur">
          ...
          >
            <div className="overflow-hidden rounded-[24px] border border-white/20 shadow-float">
              <img src={construction} alt="নির্মাণ কার্যক্রম" className="aspect-[4/5] w-full object-cover" />
            </div>
            <div className="absolute -bottom-6 -left-6 hidden rounded-2xl border border-white/25 bg-white/10 p-5 shadow-float backdrop-blur-md md:block">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[11px] uppercase tracking-widest text-white/75">সনদপ্রাপ্ত মান</p>
                </div>
              </div>
            </div>
          </motion.div>
      ...
      {/* 12. STATISTICS */}
      <section className="relative overflow-hidden bg-gradient-to-br from-primary via-primary to-primary/85 py-20 text-white">
        <div className="absolute inset-0 opacity-20">
          <img src={teamMeeting} alt="" className="h-full w-full object-cover" />
        </div>
          ...
          {[
            ...
            return (
              <div key={s.label} className="text-center">
                ...
                <CountUp end={s.end} suffix={s.suffix} className="mt-5 block text-5xl font-bold text-gold md:text-6xl" />
          ...
          {investment.map((f, i) => {
            ...
            return (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: i * 0.08 }}
                className="group relative overflow-hidden rounded-[22px] border border-border bg-surface p-8 shadow-card transition hover:-translate-y-1 hover:shadow-float"
              >
                ...
                <Landmark className="absolute bottom-4 right-4 h-6 w-6 text-primary/10 transition group-hover:text-primary/30" />
              </motion.div>
            );
          })}
        </div>
        ...
        <div className="container-luxury">
          ...
          <div className="mt-14 grid gap-6 lg:grid-cols-3">
            {[
              ...
              { image: construction, title: "নির্মাণ কার্যক্রম — Behind the Scenes", duration: "০৩:১৮" },
              ...
              >
                <img src={v.image} alt={v.title} className="h-full w-full object-cover transition duration-[1200ms] group-hover:scale-110" />
                ...
                <div className="absolute bottom-5 left-5 right-5 text-left text-white">
                  <span className="rounded-full bg-white/20 px-2 py-0.5 text-[10px] font-bold backdrop-blur">{v.duration}</span>
      ...
      <section className="container-luxury py-24">
        <div className="grid grid-cols-[minmax(0,1fr)_auto] items-end gap-6 sm:flex sm:flex-wrap sm:justify-between">
          ...
          <Button asChild variant="outline" className="shrink-0">
            <Link to="/blog">সব আর্টিকেল <ArrowRight className="h-4 w-4" /></Link>
          </Button>
        </div>
        <div className="mt-12 grid gap-6 lg:grid-cols-3">
          {blogs.map((b, i) => (
            ...
            >
              <div className="relative aspect-[16/10] overflow-hidden">
                <img src={b.image} alt={b.title} className="h-full w-full object-cover transition duration-[1200ms] group-hover:scale-110" />
              ...
              <div className="p-6">
                ...
                <h3 className="mt-2 text-lg font-bold leading-snug text-foreground transition group-hover:text-primary">{b.title}</h3>
      ...
      <section className="container-luxury pb-24">
        <div className="relative overflow-hidden rounded-[32px] border border-gold/30 bg-gradient-to-br from-primary via-primary to-primary/80 p-10 text-white shadow-float md:p-16">
          <img src={corporateHero} alt="" className="absolute inset-0 h-full w-full object-cover opacity-15" />
          ...
          <div className="relative z-10 grid gap-10 lg:grid-cols-[1.4fr_1fr] lg:items-center">
            <div>
              ...
              <p className="mt-4 max-w-xl text-white/85">
                বিশেষজ্ঞ পরামর্শদাতারা আপনার জন্য সঠিক ইউনিট, বাজেট ও EMI প্ল্যান নির্ধারণে সাহায্য করবেন।
              </p>
            </div>
            <div className="flex flex-col gap-3">
              <Button asChild variant="gold" size="xl" className="justify-between">
                <a href={`tel:${site.contact.phone}`}>
                  <span className="flex items-center gap-3"><Phone className="h-5 w-5" /> কল করুন</span>
                  <span className="text-primary/70">{site.contact.phone}</span>
                </a>
              </Button>
              <Button asChild size="xl" className="justify-between bg-emerald text-white hover:bg-emerald/90">
              ...
              <Button asChild size="xl" className="justify-between bg-white text-primary hover:bg-white/90">
                <Link to="/book-visit">
                  <span className="flex items-center gap-3"><CalendarCheck className="h-5 w-5" /> অফিস ভিজিট বুক করুন</span>
                  <ArrowUpRight className="h-4 w-4" />
                </Link>
              </Button>
            </div>
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_1.4fr] lg:items-stretch">
          <div className="rounded-[24px] border border-border bg-surface p-8 shadow-card">
            ...
            <div className="mt-6 space-y-3 border-t border-border pt-6">
              <a href={`tel:${site.contact.phone}`} className="flex items-center gap-3 text-sm font-semibold text-foreground hover:text-primary">
                <Phone className="h-4 w-4 text-gold" /> {site.contact.phone}
              </a>
              <a href={`mailto:${site.contact.email}`} className="flex items-center gap-3 break-all text-sm font-semibold text-foreground hover:text-primary">
                <HomeIcon className="h-4 w-4 text-gold" /> {site.contact.email}
              </a>
            </div>
            <Button asChild variant="gold" className="mt-6 w-full">
              <Link to="/contact">যোগাযোগ পেজ দেখুন <ArrowRight className="h-4 w-4" /></Link>
            </Button>
          </div>
